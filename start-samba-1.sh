...
nova boot --flavor=62473bef-f73b-4265-a136-e3ae87e7f1e2 --image=ubuntu-14.04-x86_64 --user-data user-config.yaml --config-drive true --key-name=abartlet --poll samba-build-$1
